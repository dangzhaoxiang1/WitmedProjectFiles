package com.whackon.witmed.system.datacode.controller;
...
/**
 * <b>系统功能 - 数据编码功能 - 数据代码类别信息控制层类</b>
 * @author Arthur
 * @version 1.0.0
 */
@Api(value = "数据代码类别信息控制层类", tags = "系统功能 - 数据编码功能 - 数据代码类别信息控制层类")
...
public class DataCodeCategoryController extends BaseController {
	...
	public ResponseVO queryByPage(@PathVariable("pageNum") Integer pageNum, @PathVariable("pageSize") Integer pageSize,
		...
		// 根据分页信息和查询对象创建查询分页视图
		QueryPageVO<DataCodeCategoryVO> queryPageVO = new QueryPageVO<>(queryVO, pageNum, pageSize);
		// 进行分页查询获得分页视图
